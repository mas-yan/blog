    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link {{ request()->is('admin') ? 'active' : '' }}" href="/admin">
          <div class="icon-sm shadow border-radius-md bg-dark text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {{-- <i class="fa fa-solid fa-tachometer-alt-average"></i> --}}
            {{-- <i class="fas fa-tachometer-alt-fast" aria-hidden="true"></i> --}}
      ...
      <li class="nav-item">
        <a class="nav-link  " href="{{ asset('') }}pages/billing.html">
          <div class="bg-dark text-white icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
